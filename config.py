...
# LLM提供商配置
LLM_PROVIDER = "volcano"  # LLM提供商: "ollama" | "minimax" | "volcano"
...
# 图片处理配置
ENABLE_IMAGE_PROCESSING = False  # 是否启用图片处理（生成图片描述）
IMAGE_VISION_PROVIDER = "volcano"  # 视觉模型提供商: "ollama" | "minimax" | "volcano"
